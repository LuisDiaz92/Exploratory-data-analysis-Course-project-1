...
reactive_power <- as.numeric(subset_dates$Global_reactive_power)
...
png("C:/Users/Luis/Desktop/R/R course/Exploratory data analysis/Assignment Week 1/plot4.png", width=480, height=480)
par(mfrow = c(2, 2)) ##This defines the structure of the 2x2 matrix where the graphs will be inserted
